...
@Service(value="examStatsService")
public class ExamStatsServiceImpl implements ExamStatsService {
	...
	public String queryStats(String suregionId, String regionId, String subregionId, String deptId, Integer examType, String examTime) {
		...
		String mysql = "select a.question_id questionId,a.question question, a.num_all num, NVL(d.num_right,0) rightNum, NVL(100*round(d.num_right/a.num_all,4),0)||'%' rate from (" + sql_all
	...
	private String getSqlGroupByQuestionIdAll(String suregionId, String regionId, String subregionId, String deptId, Integer examType, String examTime) {
		...
		mysql.append("WHERE q.exam_type=:examType AND TO_DATE( q.exam_time,'yyyy-MM') =:examTime");
		if (StringUtils.isNotEmpty(deptId)) {
